...
class BancoCentralClientTest {
    ...
    void leeLosDiasPublicadosYSaltaLosQueNoTienenDato() throws IOException {
        String respuesta = """
                {"Codigo":0,"Descripcion":"Success",
                 ...
                 "SeriesInfos":[]}
                """;
        List<UfValue> valores = BancoCentralClient.leer(respuesta, json);
    ...
    void unErrorDelServicioNoSeConfundeConCeroDias() {
        String respuesta = """
                ...
                """;
        IOException fallo = assertThrows(IOException.class, () -> BancoCentralClient.leer(respuesta, json));
