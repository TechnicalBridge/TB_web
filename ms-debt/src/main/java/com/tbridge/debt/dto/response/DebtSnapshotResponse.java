 ...
 */
@Schema(description = "El monto a cobrar de una deuda o de una cuota")
public record DebtSnapshotResponse(
        ...
        @Schema(description = "La cuota a pagar: la pedida, o la pendiente que vence primero", nullable = true,
                example = "12") Long installmentId
) {
}
